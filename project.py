...
# --- 1. Data Collection: Loading the downloaded dataset ---
# Make sure 'Mall_Customers.csv' is in the same directory as your script
# or provide the correct path, e.g., 'data/Mall_Customers.csv'
try:
...
# --- Rest of the code is identical to Method 1 ---
...
# Choose optimal K based on analysis (e.g., 5)
optimal_k = 5
